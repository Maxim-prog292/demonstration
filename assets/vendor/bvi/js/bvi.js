...
(function (global, factory) {
  ...
  var setCookie = function setCookie() {
    ...
    time += 24 * 60 * 60 * 1000;
    now.setTime(time);
    var cookie = "bvi_".concat(encodeURIComponent(name), "=").concat(encodeURIComponent(String(value)), ";path=/;expires=").concat(now.toUTCString(), ";SameSite=Lax");
  ...
  var getCookie = function getCookie() {
    var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    name = "bvi_".concat(encodeURIComponent(name), "=");
  ...
  var removeCookie = function removeCookie() {
    var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var cookie = "bvi_".concat(encodeURIComponent(name), "=;path=/;expires=Thu, 01 Jan 1970 00:00:01 GMT;SameSite=Lax");
  ...
  var Bvi = /*#__PURE__*/function () {
    ...
    _createClass(Bvi, [{
      ...
      value: function _getPanel() {
        ...
        var copyrightLink = document.querySelector('.bvi-copyright');
        document.querySelectorAll('.bvi-panel a:not([href])').forEach(function (control) {
          control.setAttribute('href', '#');
        });

        [{
          selector: '.bvi-theme-white',
          label: 'Чёрный текст на белом фоне'
        }, {
          selector: '.bvi-theme-black',
          label: 'Белый текст на чёрном фоне'
        }, {
          selector: '.bvi-theme-blue',
          label: 'Тёмно-синий текст на голубом фоне'
        }, {
          selector: '.bvi-theme-brown',
          label: 'Коричневый текст на бежевом фоне'
        }, {
          selector: '.bvi-theme-green',
          label: 'Зелёный текст на коричневом фоне'
        }, {
          selector: '.bvi-images-on',
          label: 'Показывать изображения'
        }, {
          selector: '.bvi-images-off',
          label: 'Скрыть изображения'
        }, {
          selector: '.bvi-images-grayscale',
          label: 'Чёрно-белые изображения'
        }, {
          selector: '.bvi-speech-off',
          label: 'Выключить озвучивание'
        }, {
          selector: '.bvi-speech-on',
          label: 'Включить озвучивание'
        }, {
          selector: '[data-bvi="modal"]',
          label: 'Дополнительные настройки'
        }, {
          selector: '[data-bvi="panel-hide"]',
          label: 'Свернуть панель'
        }, {
          selector: '[data-bvi="modal-close"]',
          label: 'Закрыть настройки'
        }, {
          selector: '[data-bvi="panel-show"]',
          label: 'Показать панель версии для слабовидящих'
        }].forEach(function (item) {
          var control = document.querySelector(item.selector);

          if (control) {
            control.setAttribute('aria-label', item.label);
            control.setAttribute('title', item.label);
          }
        });

        if (copyrightLink) {
          copyrightLink.setAttribute('rel', 'noopener noreferrer');
        }
      ...
      value: function _remove() {
        var clearPreferences = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
        ...
        if (clearPreferences && stringToBoolean(getCookie('reload'))) {
